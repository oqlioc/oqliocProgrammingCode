...
// function f1(a) {
//     console.log('f1 func call ' + a);
// }

// function f1(a, b) {
//     console.log('f1 func call ' + a + ' ' + b);
// }
// f1();
// f1(10);
// f1(10, 20);
...
// function f2(a = 10, b, c = 99) {  // a인자의 값을 10으로 디폴드
//     console.log('f2 func call ' + a + ' ' + b + ' ' + c);
// }
// f2();

// console.log('--------------------');

// function f3(f = () => { console.log('코끼리'); }) {  // a인자의 값을 10으로 디폴드
//     f();
