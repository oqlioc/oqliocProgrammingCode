 ...
 */
package com.example.turtle.project_achoo.View.Detail.Photo;
...
public class FaceView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ((mBitmap != null) && (mFaces != null)) {
            ...
            drawFaceRectangle(canvas, scale);  // 얼굴 주변에 사각형 그리기
//            drawFaceAnnotations(canvas, scale);  // 얼굴에 점찍기( 눈, 광대, 입꼬리, 코)
        }
    }
