...
<meta id="f_site_name" name="f_site_name" property="og:site_name" content="나이키" />
		...
		<title>registerSuccess - 나이키</title>
		<meta id="f_title" name="f_title" property="og:title" content="registerSuccess - 나이키" />
	

	
	
		<meta name="description" content="registerSuccess - 나이키" />
		<meta id="f_description" name="f_description" property="og:description" content="registerSuccess - 나이키" />
...
<script>
			...
			<div class="login-wrap width-small">
				<div class="header uk-text-center">
					...
					<p class="description">
						...
						나이키의 다양한 서비스를 이용해보세요.
					</p>
				</div>
				<div class="body width-small uk-margin-xlarge-bottom">
					<div class="uk-grid uk-text-center">
						<div class="uk-width-1-1">
							<a class="register-success-btn btn-link large width-max" href="./Nike_SigninForm.ni">로그인 하즈아</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		<div class="user-state" id="layout-mobile-menu-user">
			...
			<a data-click-area="Upper GNB" data-click-name="Logged_My page" class="btn-mypage" href="/kr/ko_kr/mypage">김홍일님</a>
