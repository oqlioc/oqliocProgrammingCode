			...
			<div class="uk-width-1-1 uk-margin-xlarge-top">
				<div class="login-wrap width-small">
					<div class="header uk-text-center">
						<!-- ======================================================================================= -->
						<h2 class="title">신발 글쓰기</h2>
						<!-- <h2 class="title" th:text="${brandName}">ESORDIO</h2>
						<p class="description">
							<th:block th:text="${brandName}">ESORDIO</th:block>를 이용하려면<br />회원 가입을 해주세요.
						</p> -->
					</div>
					<div class="body">
							...
							<div class="uk-grid">
								<div class="uk-width-1-1 dynamic-form-register">
									...
									<form method="POST" class="uk-form-large"
										action="./Nike_Admin_Shoes_Write.ad"
										...
										<div class="uk-form-row">
											...
											<div class="input-textfield width-max  "
												...
												<label for="title">상품 이름을 입력해주세요.</label> <input type="text"
													data-parsley-trigger="keyup" id="title" name="title"
													value="" />
											</div>
										</div>
										<div class="uk-form-row">
											...
											<div class="input-textfield width-max  "
												data-component-textfield="">
												<label for="price">상품 가격을 입력해주세요.</label> <input type="text"
													data-parsley-trigger="keyup" id="price" name="price"
													value="" />
											</div>
										</div>
										<div class="uk-form-row">
											...
											<div class="input-textfield width-max  "
												data-component-textfield="">
												<label for="num">상품 수량을 입력해주세요.</label> <input type="text"
													data-parsley-trigger="keyup" id="num" name="num" value="" />
											</div>
										</div>
										<div class="uk-form-row">
											<label class="uk-form-label"></label>
											<div class="input-textfield width-max  "
												data-component-textfield="">
												<input type="file" data-parsley-trigger="keyup" id="pic"
													name="pic1" accept=".jpg, .pdf, .png, .bmp, .gif, .jpeg"/>
												<input type="file" data-parsley-trigger="keyup" id="pic"
													name="pic2" accept=".jpg, .pdf, .png, .bmp, .gif, .jpeg"/>
											</div>
										</div>
										<div class="uk-form-row">
											<label class="uk-form-label"></label>
											<div class="input-textfield width-max  "
												data-component-textfield="">
												<label for="con">상품 설명을 입력해주세요.</label> <input type="text"
													data-parsley-trigger="keyup" value="" id="con" name="con"
													readonly="readonly" />
												<textarea rows="20" cols="51" style="resize: none;"
													name="content" id="content"></textarea>
											</div>
										</div>
										<div class="uk-form-row">
											<label class="uk-form-label"></label>
											<button class="button xlarge width-max" type="submit">신발
												상품 올리기</button>
										</div>
									</form>
								</div>
		...
		<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
			<div class="user-state" id="layout-mobile-menu-user">
				<a data-click-area="Upper GNB" data-click-name="join"
					...
					data-click-name="login" href="/kr/ko_kr/login?successUrl=/register">
