...
<link rel="stylesheet"
	href="https://static-breeze.nike.co.kr/kr/ko_kr/css/common_new-2.css?20181125110000" />
					...
					<div class="order-wrap order-summary-toggle">
						<h2 class="contents-title">
							...
							<div class="order__simply__tit">
								...
								<strong><%=request.getAttribute("price1")%> 원</strong>
								<button
							...
							<div class="order-tab product-checkout checkout"
								...
								<div id="order-summary" class="body view">
									...
									<div class="cart-order_list" data-order="">
										...
										<dl class="order-list">
											<input type="hidden" name="productId" data-id="10000010310"
												value="10000010310" />
											<input type="hidden" name="model" data-model="AR8830-100"
												value="AR8830-100" />
											<input type="hidden" name="skuId" value="10000051151" />
											<input type="hidden" name="quantity" data-quantity="1"
												value="1" />
											<input type="hidden" name="orderItemId" value="21066299" />

											<dt class="image-wrap">

												<img
													src="/Nike/Nike_image/<%=request.getAttribute("pic1")%>"
													alt="상품사진" />
											...
											<dd class="order-info">
												<a class="tit" data-name="<%=request.getAttribute("title1")%>"
													data-eng-name="<%=request.getAttribute("title1")%>"
													href="/kr/ko_kr/t/men/fw/nike-sportswear/AR8830-100/cwyl97/blazer-royal-qs"
													title="<%=request.getAttribute("title1")%>"><%=request.getAttribute("title1")%></a>

												<div class="style-code" data-model="AR8830-100"><%=request.getAttribute("board1")%> <%=request.getAttribute("category1")%></div>
												...
												<span class="uk-hidden" data-upc="883419769894"
													data-model="AR8830-100"></span>
												...
												<span class="qty" data-quantity="1">수량 : 1개</span> <span
													...
													data-retail-price="<%=request.getAttribute("price1")%>"><%=request.getAttribute("price1")%> 원</strong>
									...
									<div class="uk-width-1-1 info-price">
										...
										<span class="item-price"> <span class="label">상품
												금액</span> <span class="price"> <strong><%=request.getAttribute("price1")%> 원</strong>
										</span>
										</span>
										
										<span class="delivery-price"> <span class="label">배송비</span>
										...
										<div class="total-price">
											<span class="label">총 결제 예정 금액</span> <span
												class="price sale total"><strong data-amount="<%=request.getAttribute("price1")%>"><%=request.getAttribute("price1")%>
													원</strong></span>
										</div>
						...
						<div class="order-tab-wrap">
							...
							<div class="order-tab" data-order-tab="">
								<div class="header">
									...
									<span class="preview"><%=request.getAttribute("nikeaddress1")%></span> <i
										class="icon-toggle-shipping icon-plus"></i> <i
										class="icon-toggle-shipping icon-minus uk-hidden"></i>
								...
								<div pid="paymentIds2">
									<div id="shipping-review" class="body uk-hidden view"
										data-module-checkout-address-review="">
										<div class="order-complete">
											<div class="uk-grid">
												<div class="uk-width-7-10">
													<dl>
														<!-- <dt>받으시는 분</dt> -->
														<dd class="uk-margin-small-bottom" data-name="<%=request.getAttribute("nikename1")%>"><%=request.getAttribute("nikename1")%></dd>
													</dl>
													<dl>
														<!-- <dt>연락처</dt> -->
														<dd class="uk-margin-small-bottom"
															data-component-phone="{phonenum:<%=request.getAttribute("nikephone1")%>}"
															data-phone="<%=request.getAttribute("nikephone1")%>"><%=request.getAttribute("nikephone1")%></dd>
													</dl>
													<dl>
														<!-- <dt>배송지 주소</dt> -->
														<dd class="uk-margin-small-bottom text-box">
															<span data-zipcode="<%=request.getAttribute("nikeaddress21")%>">(<%=request.getAttribute("nikeaddress21")%>)</span> <span
																data-address="<%=request.getAttribute("nikeaddress1")%>"><%=request.getAttribute("nikeaddress1")%></span> <span>147-95</span>
														</dd>
													</dl>
													<dl>
														<!-- <dt>배송 메모</dt> -->
														...
														<dd><%=request.getAttribute("nikemessage1")%></dd>
													</dl>
												</div>
											</div>
										</div>
							...
							<div class="order-tab" data-order-tab="">
								<div class="header">
									...
									<i class="icon-toggle-promo icon-plus uk-hidden"></i> <i
										class="icon-toggle-promo icon-minus"></i>

								</div>
								<div>
									<div id="gift-promoform" class="gift-promoform body view">
										...
										<ul class="order-field-container uk-grid">
											<li
												...
												<div
													...
													class="promotion">
													<form method="POST"
														class="promo-form uk-margin-small-bottom"
														action="/kr/ko_kr/cart/promo">
														<div class="uk-grid uk-margin-mini-bottom">
															<div class="uk-width-1-1">
																<div class="uk-grid uk-grid-collapse">
																	<div class="uk-width-2-10">
																		<span class="label">프로모코드</span>
																	</div>
																	<div class="uk-width-8-10">
																		<div class="input-btn-group">
																			<span class="input-textfield width-max"
																				data-component-textfield=""> <label
																				for="promoCode">프로모 코드 입력</label> <input type="text"
																				name="promoCode" id="promoCode" />
																			</span>
																			<button type="submit"
																				class="button line xlarge width-fix btn-submit"
																				style="width: 110px;">적용</button>
																		</div>
																	</div>
																...
																<div
																	class="uk-grid uk-grid-collapse uk-margin-mini-top promo-error-message uk-hidden">
																	<div class="uk-width-2-10"></div>
																	<div class="uk-width-8-10">
																		<span class="text">Coupon code "1212" is
																			unknown.</span>
																	</div>
																</div>
														...
														<input type="hidden" name="csrfToken"
															value="MZI5-32Q3-495O-0XX3-F21R-1J0X-I45M-8YUH" />
													</form>
												</div>
											</li>
							...
							<div class="order-tab reservations-order" data-order-tab=""
								...
								<div class="header">
									...
									<i class="icon-toggle-payment icon-plus uk-hidden"></i> <i
										class="icon-toggle-payment icon-minus"></i>
								...
								<div id="payment-review" class="view"
									data-module-order-payment="">


									<input type="hidden" name="cartId" value="16524735" />
									<div class="body">
										...
										<ul class="order-field-container uk-grid">
											...
											<li
												...
												<div class="payment-method-list" data-payment-method="">

													<div class="payment-method-item active"
														data-m-redirect-url="https://www.nike.com/kr/ko_kr/checkout/iamport-checkout/hosted/return"
														data-method="card" data-identity-code="imp35948874"
														data-provider="IAMPORT"
														data-notice-url="https://bill-breeze.nike.co.kr/kr/ko_kr/checkout/iamport-checkout/notification"
														data-type="CREDIT_CARD" data-pg="html5_inicis.MOInikekr2">
													...
													<div class="payment-method-item"
														data-m-redirect-url="https://www.nike.com/kr/ko_kr/checkout/iamport-checkout/hosted/return"
														data-method="trans" data-identity-code="imp35948874"
														data-provider="IAMPORT"
														data-notice-url="https://bill-breeze.nike.co.kr/kr/ko_kr/checkout/iamport-checkout/notification"
														data-type="BANK_ACCOUNT" data-escrow="true"
														data-pg="html5_inicis.MOInikekr2">
														...
														<h6 class="payment-method-item-title">실시간계좌이체</h6>
													...
													<div class="payment-method-item"
														data-m-redirect-url="https://www.nike.com/kr/ko_kr/checkout/iamport-checkout/hosted/return"
														data-method="phone" data-identity-code="imp35948874"
														data-provider="IAMPORT"
														data-notice-url="https://bill-breeze.nike.co.kr/kr/ko_kr/checkout/iamport-checkout/notification"
														data-type="MOBILE" data-pg="html5_inicis.MOInikekr2">
														...
														<h6 class="payment-method-item-title">휴대폰소액결제</h6>
													...
													<div class="payment-method-item"
														...
														data-provider="IAMPORT"
														data-notice-url="https://bill-breeze.nike.co.kr/kr/ko_kr/checkout/iamport-checkout/notification"
														data-type="KAKAO_POINT" data-pg="kakaopay">
														...
														<h6 class="payment-method-item-title">카카오페이</h6>
											...
											<li
												...
												<div class="font-size-s uk-margin-bottom">
													<span style="color: red;"><strong>휴대폰 소액결제로
															주문하시는 경우, 부분 반품 진행이 불가합니다.</strong></span><span style="color: red;"></span>
												</div>
												...
												<form name="checkout-agree-form">
													...
													<div class="input-form-group">
														<span class="input-checkbox" data-component-checkbox="">
															<input type="checkbox" id="isCheckoutAgree"
															name="isCheckoutAgree" data-parsley-required=""
															data-parsley-required-message="Validation_checkout_agree" />
															<label for="isCheckoutAgree"> <i
																class="brz-icon-checkbox">rediobox</i> <span
																class="label font-size-s">위 주문의 상품, 가격, 할인, 배송정보에
																	동의합니다.</span>
														</label>
														</span>
													</div>
									...
									<div class="footer">
										...
										<form method="POST" id="complete_checkout"
											class="uk-width-small-1-1 uk-width-medium-1-1"
											action="./Nike_Cart_Complete_.nf">
											
											<input type="hidden" name="email" value="<%=id%>">
											<input type="hidden" name="title" value="<%=request.getAttribute("title1")%>">
											<input type="hidden" name="itemnum" value="<%=request.getAttribute("itemnum1")%>">
											<input type="hidden" name="price" value="<%=request.getAttribute("price1")%>">
											<input type="hidden" name="board" value="<%=request.getAttribute("board1")%>">
											<input type="hidden" name="num" value="<%=request.getAttribute("num1")%>">
											<input type="hidden" name="category" value="<%=request.getAttribute("category1")%>">
										
											<input type="hidden" name="nikename1" value="<%=request.getAttribute("nikename1")%>">
											<input type="hidden" name="nikephone1" value="<%=request.getAttribute("nikephone1")%>">
											<input type="hidden" name="nikeaddress1" value="<%=request.getAttribute("nikeaddress1")%>">
											<input type="hidden" name="nikeaddress21" value="<%=request.getAttribute("nikeaddress21")%>">
											<input type="hidden" name="nikemessage1" value="<%=request.getAttribute("nikemessage1")%>">
											
											<button type="submit" class="button xlarge width-max" ><%=request.getAttribute("price1")%> 원 결제하기</button>
											<input type="hidden" name="csrfToken"
												value="MZI5-32Q3-495O-0XX3-F21R-1J0X-I45M-8YUH" />
										</form>
									</div>
...
<script id="swipe-instagram-template" type="text/x-handlebars-template">
	...
	<div class="uk-offcanvas" id="minicart">
		<div class="section-minicart uk-offcanvas-bar uk-offcanvas-bar-flip"
			...
			<input type="hidden" name="itemSize" value="1" /> <input
				type="hidden" name="cartId" value="16524735" />
				...
				<div class="uk-width-1-1">
					<dl class="order-list" data-product-item="">
						...
						<dt class="image-wrap">
							...
							<img
								src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/product/AR8830-100_AR8830-100_primary.jpg?thumbnail"
								alt="나이키 블레이저 로얄 QS" />
						...
						<dd class="order-info">
							...
							<a class="tit" data-name="나이키 블레이저 로얄 QS"
								data-eng-name="나이키 블레이저 로얄 QS"
								href="/kr/ko_kr/t/men/fw/nike-sportswear/AR8830-100/cwyl97/blazer-royal-qs"
								title="나이키 블레이저 로얄 QS">나이키 블레이저 로얄 QS</a>

							<div class="style-code" data-model="AR8830-100">스타일 :
								AR8830-100</div>
							...
							<div class="current-option-wrap">
								...
								<input type="hidden" name="FW_SIZE" value="250" />
								<!-- bundle product -->


								<!-- product -->

								<span class="opt" data-opt="{FW_SIZE:250}"
									data-attribute-name="FW_SIZE">사이즈 : 250</span>
							...
							<span class="opt quantity">수량: 1</span> <span class="price-wrap">
								<div class="total-price">
									<strong class="retail-price" data-retail-price="129000">129,000
										원</strong>

								</div>
							</span> <a class="btn-delete" data-remove-item=""
								href="/kr/ko_kr/cart/remove?orderItemId=21066299&amp;productId=10000010310">
			...
			<div class="cart-order_price uk-grid">
				<span class="order-price uk-width-1-1"> <span>총 상품금액</span> <strong>129,000
						원</strong>
				</span>
			</div>
	...
	<script type="text/javascript"
		src="https://static-breeze.nike.co.kr/kr/ko_kr/js/libs_new-2.js?20181125110000"></script>
	...
	<script type="text/javascript"
		src="https://static-breeze.nike.co.kr/kr/ko_kr/js/index_new-2.js?20181125110000"></script>
