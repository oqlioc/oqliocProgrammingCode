								...
								<div id="order-summary" class="body view">
									...
									<div class="cart-order_list" data-order="">
										...
										<dl class="order-list">
											...
											<dt class="image-wrap">
												...
												<img src="/Nike/Nike_image/${order_list_1.PIC1}"
													alt="상품사진" />
											...
											<dd class="order-info">
												...
												<div class="style-code" data-model="942842-107">${order_list_1.BOARD}
													${order_list_1.CATEGORY}</div>
												...
												<span class="price-wrap"> <strong
													class="retail-price" data-retail-price="239000">${order_list_1.PRICE}
														원</strong>
									...
									<div class="uk-width-1-1 info-price">
										...
										<span class="item-price"> <span class="label">상품
												금액</span> <span class="price"> <strong>${order_list_1.PRICE}
													원</strong>
										</span>
										</span>
										...
										<div class="total-price">
											<span class="label">총 결제 예정 금액</span> <span
												class="price sale total"><strong data-amount="239000">${order_list_1.PRICE}
													원</strong></span>
										</div>
								...
								<div data-checkout-step="shipping">
									<div data-module-order-delivery="">
										<form method="post" id="shipping_info" name="shipping_info"
											...
											action="./Nike_Cart_Order_2.nf" enctype="multipart/form-data">
