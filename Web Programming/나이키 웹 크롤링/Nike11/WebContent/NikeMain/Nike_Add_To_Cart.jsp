...
<link rel="stylesheet" href="https://static-breeze.nike.co.kr/kr/ko_kr/css/common_new-2.css?20181125110000" />
			...
			<div class="twodepth-maxwidth">
				...
				<ul class="twodepth-submenu-t1">
					<ul class="header-menu_threedepth">
						...
						<li>
							<a href="/kr/ko_kr/w/men/xb/xc/f/clearance" data-click-area="GNB_feature" data-click-name="가격인하">가격인하</a>
						</li>
					</ul>
			...
			<div class="twodepth-maxwidth">
				...
				<ul class="twodepth-submenu-t1">
					<ul class="header-menu_threedepth">
						...
						<li>
							<a href="/kr/ko_kr/w/women/xb/xc/f/clearance" data-click-area="GNB_feature" data-click-name="가격인하">가격인하</a>
						</li>
					</ul>
			...
			<div class="twodepth-maxwidth">
				...
				<ul class="twodepth-submenu-t1">
					<ul class="header-menu_threedepth">
						...
						<li>
							<a href="/kr/ko_kr/w/boys/xb/xc/f/clearance" data-click-area="GNB_feature" data-click-name="가격인하">가격인하</a>
						</li>
					</ul>
			...
			<div class="twodepth-maxwidth">
				...
				<ul class="twodepth-submenu-t1">
					<ul class="header-menu_threedepth">
						...
						<li>
							<a href="/kr/ko_kr/w/girls/xb/xc/f/clearance" data-click-area="GNB_feature" data-click-name="가격인하">가격인하</a>
						</li>
					</ul>
    ...
    function msg(){
        alert('준비중입니다.');
			...
			<div class="header-menu_etc">
				...
				<a class="mini-cart" v-bind:class="{empty:isEmpty}" v-bind:icon-text-attr="itemCount" data-click-area="Upper GNB" data-click-name="Cart" data-component-cartitemlen="{itemCount:1}" href="/kr/ko_kr/cart">
					...
					<div class="item-list-wrap" id="cart">
						<div class="mypage-cart" id="current-item-wrap">
							<div class="product-select-all">
								<a class="btn-cart-delete-All" href="/kr/ko_kr/cart/removeAll">전체삭제</a>
							</div>
							
<c:set var="totalprice" value="0" />					
<c:forEach items="${cartlist}" var="dtos">
<!-- 장바구니 리스트------------------------------------------------ -->			
	<div class="product-opt_cart" data-product-item="" data-containsKey="false" id="productRow21042513">

		<input type="hidden" name="categoryId" value="10210" />
		<input type="hidden" name="productId" data-id="10000008940" value="10000008940" />
		<input type="hidden" name="skuId" value="10000041954" />
		<input type="hidden" name="orderItemId" value="21042513" />
		<input type="hidden" name="quantity" data-quantity="1" value="1" />
		<input type="hidden" name="producturl" value="/kr/ko_kr/t/women/ap/nike-sportswear/939435-030/ixcc09/as-w-nsw-dwn-fill-jkt-rev" />
		...
		<div class="item-detail">
			...
			<div class="item-info">
				...
				<div class="info-wrap">
					...
					<a class="tit" data-name="나이키 스포츠웨어 리버시블 다운 필 재킷" data-eng-name="나이키 스포츠웨어 리버시블 다운 필 재킷" href="/kr/ko_kr/t/women/ap/nike-sportswear/939435-030/ixcc09/as-w-nsw-dwn-fill-jkt-rev" title="나이키 스포츠웨어 리버시블 다운 필 재킷">${dtos.TITLE}</a>

					
					<div class="style-code" data-model="939435-030">${dtos.CATEGORY}</div>

					

					
						<span class="uk-hidden" data-upc="887230043577" data-model="939435-030"></span>
						<!-- skuOptionDisplayProcess -->
	
		
			<div class="current-option-wrap">
				
					<input type="hidden" name="AP_SIZE" value="80PSP" />
					<!-- bundle product -->
					

					<!-- product -->
					
						<span class="opt" data-opt="{AP_SIZE:80PSP}" data-attribute-name="AP_SIZE">분류 : ${dtos.BOARD}</span>
...
<!-- itemAttribute -->
					...
					<span class="opt quantity">수량 : ${detail_list.NUM}</span>
	...
	<button href="#common-modal" class="optchange-btn btn-link sky-blue width-max">옵션 변경</button>
</div>
			...
			<div class="total-price"><strong class="retail-price" data-retail-price="329000">가격 :${dtos.PRICE}</strong>
</div>
			<div class="delete-btn">
				
				
					<a class="btn-delete" href="./Nike_Cart_List_Remove.nf?cartnum=${dtos.CARTNUM}">
		...
		<div class="btn-box">
			<div class="btn-wishlist-add">
				
					
					<button class="wish-btn btn-link sky-blue normal" data-component-wishlistbtn="{api:/kr/ko_kr/account/wishlist/addProduct, productId:10000008940, addMsg:상품이 위시리스트에 추가 되었습니다., removeMsg:상품이 위시리스트에서 삭제 되었습니다.}">
						<i class="icon-wishlist"></i> 위시리스트에 추가
					</button>
					...
					<form method="POST" action="/kr/ko_kr/account/later/add">
						<button type="submit" class="later-btn btn-link sky-blue normal" data-msg="상품을 나중에 구매하기로 이동하였습니다.">
							<i class="icon-after"></i> 나중에 구매하기
						</button>
					<input type="hidden" name="csrfToken" value="8VL2-L8P7-500F-Y2NV-H90X-37JR-XXCF-2EAE" /></form>
...
<c:set var="totalprice" value="${totalprice + dtos.PRICE}"/>
						...
						<div class="pc-only"><div class="mypage-cart later">
	...
	<div class="product-checkout__in-box product-checkout__in-box--pay">
		...
		<div class="info-price">
			...
			<span class="item-price">
				...
				<span class="price">
					...
					<strong><c:out value="${totalprice}"/> 원</strong>
				</span>
			</span>
		...
		<div class="total-price">
			...
			<span class="price sale total"><strong><c:out value="${totalprice}"/> 원</strong></span>
		</div>
		
		<a class="btn-link xlarge width-max btn-order indian-red" href="./Nike_Cart_Form_Order_2.nf?email=<%= id%>">주문하기</a>
	</div> 
	...
	<li>장기간 장바구니에 보관하신 상품은 시간이 지남에 따라 가격과 혜택이 변동 될 수 있으며, 최대 30일동안 보관됩니다.</li>
					...
					<div class="mobile-only"><div class="mypage-cart later">
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		<div class="user-state" id="layout-mobile-menu-user">
			...
			<a data-click-area="Upper GNB" data-click-name="Logged_My page" class="btn-mypage" href="/kr/ko_kr/mypage">정재은님</a>
		...
		<ul class="mobile-menu_onedepth">
						...
						<li class="mobile-onedepth_list">
							...
							<ul class="mobile-menu_twodepth">
								...
								<li class="mobile-twodepth_list">
									<a class="mobile-menu-dynamic link" data-click-area="GNB_feature" data-click-name="Men_가격인하" data-click-enable="true" href="/kr/ko_kr/w/men/xb/xc/f/clearance">
										<span>가격인하</span>
						...
						<li class="mobile-onedepth_list">
							...
							<ul class="mobile-menu_twodepth">
								...
								<li class="mobile-twodepth_list">
									<a class="mobile-menu-dynamic link" data-click-area="GNB_feature" data-click-name="Women_가격인하" data-click-enable="true" href="/kr/ko_kr/w/women/xb/xc/f/clearance">
										<span>가격인하</span>
						...
						<li class="mobile-onedepth_list">
							...
							<ul class="mobile-menu_twodepth">
								...
								<li class="mobile-twodepth_list">
									<a class="mobile-menu-dynamic link" data-click-area="GNB_feature" data-click-name="Boys_가격인하" data-click-enable="true" href="/kr/ko_kr/w/boys/xb/xc/f/clearance">
										<span>가격인하</span>
						...
						<li class="mobile-onedepth_list">
							...
							<ul class="mobile-menu_twodepth">
								...
								<li class="mobile-twodepth_list">
									<a class="mobile-menu-dynamic link" data-click-area="GNB_feature" data-click-name="Girls_가격인하" data-click-enable="true" href="/kr/ko_kr/w/girls/xb/xc/f/clearance">
										<span>가격인하</span>
			...
			<div class="uk-grid">
				<div class="company-info uk-width-medium-1-4">
					...
					<p><a data-click-area="Footer GNB" data-click-name="Store locator" href="/kr/ko_kr/store">매장안내</a></p>
						...
						<p class="pc-only"><a href="/kr/ko_kr/logout">로그아웃</a></p>
...
<div class="uk-offcanvas" id="minicart">
	<div class="section-minicart uk-offcanvas-bar uk-offcanvas-bar-flip" data-module-minicart="{miniCartCnt:.cart-num}">
			...
			<input type="hidden" name="itemSize" value="1" />
			<input type="hidden" name="cartId" value="16511748" />
			<div class="cart-order_list uk-grid">
				...
				<div class="uk-width-1-1">
					<dl class="order-list" data-product-item="">
						<input type="hidden" name="productId" data-id="10000008940" value="10000008940" />
						<input type="hidden" name="model" data-model="939435-030" value="939435-030" />
						<input type="hidden" name="skuId" value="10000041954" />
						<input type="hidden" name="quantity" data-quantity="1" value="1" />
						<input type="hidden" name="orderItemId" value="21042513" />
						...
						<dt class="image-wrap">
								...
								<img src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/product/939435-030_939435-030_primary.jpg?thumbnail" alt="나이키 스포츠웨어 리버시블 다운 필 재킷" />
						...
						<dd class="order-info">
							...
							<a class="tit" data-name="나이키 스포츠웨어 리버시블 다운 필 재킷" data-eng-name="나이키 스포츠웨어 리버시블 다운 필 재킷" href="/kr/ko_kr/t/women/ap/nike-sportswear/939435-030/ixcc09/as-w-nsw-dwn-fill-jkt-rev" title="나이키 스포츠웨어 리버시블 다운 필 재킷">나이키 스포츠웨어 리버시블 다운 필 재킷</a>
							
							<div class="style-code" data-model="939435-030">스타일 : 939435-030</div>
			...
			<div class="current-option-wrap">
					...
					<!-- product -->
						...
						<span class="opt" data-opt="{AP_SIZE:80PSP}" data-attribute-name="AP_SIZE">사이즈 : 80(S)</span>
...
<!-- itemAttribute -->
							...
							<span class="price-wrap">
								<div class="total-price"><strong class="retail-price" data-retail-price="329000">329,000 원</strong>

</div>
							</span>

							<a class="btn-delete" data-remove-item="" href="/kr/ko_kr/cart/remove?orderItemId=21042513&amp;productId=10000008940">
								<i class="icon-delete_bold"></i>
							</a>
			...
			<div class="cart-order_price uk-grid">
				<span class="order-price uk-width-1-1">
					<span>총 상품금액</span>
					<strong>329,000 원</strong>
				</span>
			</div>
			...
			<div class="cart-order_buy uk-grid">
				<div class="uk-width-1-1">
					<a class="btn-link width-max large line" href="/kr/ko_kr/cart">장바구니 가기</a>
				</div>
				<div class="uk-width-1-1 uk-margin-mini-top">
					<a class="btn-link width-max large indian-red" data-checkout-btn="" href="/kr/ko_kr/checkout">바로구매</a>
				</div>
			</div>
...
<div id="common-modal-large" class="uk-modal detail-info-modal">
	...
	<script type="text/javascript" src="https://static-breeze.nike.co.kr/kr/ko_kr/js/libs_new-2.js?20181125110000"></script>
...
<script type="text/javascript" src="https://static-breeze.nike.co.kr/kr/ko_kr/js/index_new-2.js?20181125110000"></script>
...
<script>
	var itemList = [];
	(function() {
		var $itemList = $("#current-item-wrap").find("[data-product-item]");
		$.each( $itemList, function( index, data ){
			var $item = $(data);
			itemList.push({
				id : $item.find("[data-id]").data("id"),
				name : $item.find("[data-name]").data("name"),
				upc : $item.find("[data-upc]").data("upc"),
				model : $item.find("[data-model]").data("model"),
				option : (function(){
					var opt = [];
					$.each( $item.find("[data-opt]"), function(){
						opt.push(Core.Utils.strToJson($(this).data("opt"), true))
					});
					return opt;
				})(),
				quantity : $item.find("[data-quantity]").data("quantity"),
				price : $item.find("[data-sale-price]").data("sale-price"),
				retailPrice : $item.find("[data-retail-price]").data("retail-price"),
			});
		})
	})();
	...
	if( $(".promo-list").find(".applied").length > 0 ){
		...
		marketingData.promoList = promoList;
	}	
...
<script type="text/javascript">
//<![CDATA[ 
  var roosevelt_params = { retargeting_id: 'J9k9P7su-Hq2YSaw6UyfnA00', tag_label: 'd0-9TCZA6VYdYQxvpWXYue2fqbA' };
//]]>
</script>
<script type="text/javascript" src="//adimg.daumcdn.net/rt/roosevelt.js" async="true">
</script>
...
<script type="text/javascript" src="/kr/ko_kr/js/wcs-2.js?20181125110000"></script>
...
<script>
    ...
    if( itemList != null && itemList.length > 0 ){
    	$.each( itemList, function(index, data){
    		pCartItemList.push(String(data.id));
    	})
    }
    //]]>
    
	Wcs.setCartInfo(pCartItemList);
