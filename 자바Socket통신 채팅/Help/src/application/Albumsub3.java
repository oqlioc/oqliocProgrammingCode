...
public class Albumsub3 {
	@FXML
	public void home6(ActionEvent event) throws IOException {
	...
	@FXML
	private void naver6() throws IOException, URISyntaxException {
		Desktop.getDesktop().browse(new URI("https://cafe.naver.com/bufsbithigh6?iframe_url=/MyCafeIntro.nhn%3Fclubid=29531859"));
	}
	
	@FXML
	private void github6() throws IOException, URISyntaxException {
		Desktop.getDesktop().browse(new URI("https://github.com/"));
	}

	public void albumpage13(ActionEvent event) throws IOException {
	...
	public void calpage13(ActionEvent event) throws IOException {
